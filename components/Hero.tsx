        ...
        <div className="relative h-screen text-white overflow-hidden">
            ...
            <div className="relative flex flex-col justify-center items-center h-full text-center">
                ...
                <div className="flex gap-5">
                    <Link href="/clothes" className="bg-red-500 text-white hover:bg-red-700 py-2.5 px-6 md:px-10 text-lg font-semibold hover:scale-105
                    hover:shadow-lg">Order Now</Link>
                    <Link href="/contact" className="bg-transparent border border-red-500 text-white hover:bg-red-700 py-2.5 px-6 md:px-10 text-lg font-semibold hover:scale-105
